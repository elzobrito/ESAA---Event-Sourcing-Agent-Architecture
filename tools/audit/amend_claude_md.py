#!/usr/bin/env python3
"""FIX-1541 â€” Amenda CLAUDE.md substituindo 'enforcement.mode=reject' por '{reject, require_field, require_step}'.
...
def main() -> int:
    ...
    old = "Trate cada lesson com `enforcement.mode=reject` como **constraint inviolÃ¡vel**"
    new = "Trate cada lesson com `enforcement.mode` em {`reject`, `require_field`, `require_step`} como **constraint inviolÃ¡vel**"
    if old in txt:
